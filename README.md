...
该计划是 PBH-BTN 为充分利用 BTN 服务器闲时的网络和计算资源维护的公益项目，不对可靠性和稳定性做出保证。
...
注：为充分利用资源，商业或主要为盈利为目的的字幕、压制、发布组不包含在加速范围内，任何带有 `DBD`, `搬运`, `Dynamis One` 关键字的种子也将被排除在过滤器外；对于多语言订阅源，只有 CHT、CHS 条目包含在覆盖范围内。  
...
[【点此开始监工】](https://swarmaccelerator-vnc.pbh-btn.com/) [【订阅任务推送】](https://t.me/pbhbtn_swarmaccelerator_monitor)
